      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            <li class="active">
              <a href="" onmouseover="style.color='blue'" onmouseout="style.color='black'">Employee</a>
            </li>
            <li>
              <a href="home_deductions.php" onmouseover="style.color='blue'" onmouseout="style.color='black'">Deduction/s</a>
            </li>
            <li>
