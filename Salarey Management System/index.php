...
<html lang="en">
  ...
  <body style="background-image: linear-gradient(to top left, lightblue,white );">
    ...
    <div class="container" style="background-image: linear-gradient(to top left, lightblue,white);">
      <div class="masthead" >
        <h3>
          <b>Salery Management  System</b>
            <a data-toggle="modal" href="#colins" class="pull-right"><b><?php echo $_SESSION['username']; ?></b></a>
        </h3>
        <nav>
          <ul class="nav nav-justified">
            <li><a href="home_employee.php" onmouseover="style.color='blue'" onmouseout="style.color='black'">Employee</a></li>
            <li><a href="home_deductions.php" onmouseover="style.color='blue'" onmouseout="style.color='black'">Deduction/s</a></li>
            <li><a href="home_salary.php" onmouseover="style.color='blue'" onmouseout="style.color='black'">Income</a></li>
          </ul>
        </nav>
      </div><br>
      ...
      <div class="jumbotron" style="background-color:lightblue;">
        <h1>Salery Management System</h1>
        <p class="lead">This Salery Management  system has improvised all the basic exercise to manage the salary of the employees in Ben bakers ,Ganemulla.</p>
