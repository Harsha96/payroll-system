...
<html lang="en">
  ...
  <option value="<?php echo $love+$gsis+$bir+$phil; ?>">No Loans</option>
                      <option value="<?php echo $loans+$love+$gsis+$bir+$phil; ?>">1500 Loans</option>
                            <option value="<?php echo $loans*2+$love+$gsis+$bir+$phil; ?>">3000 Loans</option>
                    </select>
                  </div>
                  </div>
